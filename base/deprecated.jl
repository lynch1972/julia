...
@deprecate mapreduce(op, v0, itr) mapreduce(op, itr; init = v0)
@deprecate mapfoldl(op, v0, itr) mapfoldl(op, itr; init = v0)
@deprecate mapfoldr(op, v0, itr) mapfoldr(op, itr; init = v0)
